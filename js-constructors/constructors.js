...
var mySecret = "There is a secret in the fridge!";
...
// be stored using a private variable.
...
function Safe(sensitive, keyInstance) {
  var _sensitive = sensitive;
  var _key = keyInstance;
  this.unlock = function(unlockKey) {
    if(_key === unlockKey) {
      return _sensitive;
    } else {
      return "Sorry, we're not giving you shit.";
    }
...
$('dom').on('click', '.target', page.something
